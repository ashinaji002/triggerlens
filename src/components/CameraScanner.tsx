...
export const CameraScanner: React.FC<CameraScannerProps> = ({ onImageCaptured }) => {
  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-md mx-auto">
      ...
      <div className="relative aspect-[3/4] bg-zinc-50 border-2 border-dashed border-zinc-300 rounded-3xl flex flex-col items-center justify-center p-6 text-center">
        {/* Corner Indicators */}
        ...
        <Camera className="w-12 h-12 text-zinc-300 mb-4" />
